      ...
      >
        <defs>
          <pattern id={id} width="6" height="8" patternUnits="userSpaceOnUse">
            <path d="M0 0H6M0 8H6" className="stroke-primary/30" fill="none" />
          </pattern>
        </defs>
...
function Glow() {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden lg:right-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem] bg-background">
      <svg
      ...
      >
        <defs>
          <radialGradient id={`${id}-desktop`} cx="100%">
            ...
            <stop offset="53.95%" stopColor="hsl(var(--primary) / 0.09)" />
      ...
      <div className="absolute inset-x-0 bottom-0 right-0 h-px mix-blend-overlay lg:left-auto lg:top-0 lg:h-auto lg:w-px" />
    </div>
  );
}
